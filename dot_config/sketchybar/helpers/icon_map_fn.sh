#!/usr/bin/env bash
# Vendored from github.com/kvndrsslr/sketchybar-app-font ; auto-generated
# Resolves a macOS app name to a `:slug:` string that sketchybar-app-font renders as a brand glyph.
function __icon_map() {
    case "$1" in
    "Live")
        icon_result=":ableton:"
